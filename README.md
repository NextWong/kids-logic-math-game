...
- 加法：看两组物品，选择总数。
- 规律：观察图形序列，选择下一个图形。
- 逻辑：练习找一样、找不同、配对补空格、比较多少、数字规律。
- 年龄分级：3、4、5、6 岁四档，题目池明确分层：
  - 3 岁：数到 5，5 以内加法，AB 规律，找一样/找不同。
  - 4 岁：数到 8，8 以内加法，配对补空格，比较多少。
  - 5 岁：数到 10，10 以内加减法，数字规律，复杂图形规律。
  - 6 岁：数到 12，12 以内加减法，缺数加法，跳数规律。
